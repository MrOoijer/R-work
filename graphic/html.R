...
<h6>Fixes and extensions</h6><small>
<dl>
...
tutorial1.1=
 "<h5>Sources</h5><p>A number of scientific institutes keep track of the global temperature. Each month
...
<h5>Aim</h5><p>Our aim is to find as many factors as possible that explain the seemingly
...
tutorial2.1=
 "<h5>Rising temperatures and CO2 levels</h5><p>Since 1880 the earth temperature has been rising slowly. 
...
tutorial2.2=
 ...
 </p><h5>CO2</h5><p>Modern physics tells us that one of the major causes of warming is the increase in CO2 in the atmosphere. 
...
<h5>Changes to the regression</h5><p>With the first slider change the period for
...
<h5>Fit</h5><p>Statistics knows a number of methods to calculate how good the regression line fits
...
<h5>Confidence Level</h5><p>The global temperature time series is a so called autocorrelated time series. That means that the tempartures of this month depend to some extend of the
...
tutorial3.1=
 "<h5>Solar Irradiation</h5><p>The sun shines down on the earth with tremendous force
...
tutorial3.2=
 "<hr><h5>Volcanoes</h5><p>Volcanoes can temporarily cool the planet. Big outbreaks have caused some
summers to be very cool. The particle that cause the cooling are called aerosols. Check the box for volcanoes 
to see the impact on the temperature.</p><h5>Human Aerosols</h5>
...
<h5>Day Lengths</h5><p>Other interesting phenomena are the very small changes in the length of the day (LoD).
...
tutorial4.2=
 "<hr>
<h5>El Nino and Atlantic Multidecadel Oscillation</h5><p>First check these boxes and you will see that 
...
but it is mainly similar to a little part of the Length of day signal.</p>
 <h5> Pacific Decadal Oscillation</h5><p>Less clear is the contribution of the PDO, in the mid Pacific. It is sometimes mentioned 
...
tutorial5.1=
 "<h5>Seasons</h5><p>The orbit of the earth around the sun is not a perfect circle, but an ellipse. 
 ...
 "
tutorial5.2=
 "<h5>Planet Cycles</h5><p>There are some planetary cycles (look them up in Wikipedia!)
...
"<hr><p>Enjoy!</p>"
tutorial6.3=
  "<h5>Was there a pause? No!</h5><p>In our second example we zoom in on the last 17-18 years: from 1997 onwards.
